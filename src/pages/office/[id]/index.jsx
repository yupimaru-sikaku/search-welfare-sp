  ...
  return (
    <Layout title={props.officeData.officeName}>
      ...
      <Link href="/office" passHref>
        <a className="border mt-10 mx-auto w-56 border-gray-600 block rounded-lg font-bold py-4 px-6 flex items-center text-white bg-gray-500 hover:text-white hover:bg-transparent">
          <svg
